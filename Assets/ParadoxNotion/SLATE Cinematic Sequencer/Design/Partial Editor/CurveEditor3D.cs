                ...
                for ( var k = 0; k < curveX.length; k++ ) {
                    ...
                    if ( kIndex == k ) {
                        if ( Tools.current == Tool.Move ) {
                            ...
                            var fmh_195_68_639245411231143254 = Quaternion.identity; newValue = Handles.FreeMoveHandle(pos, pointSize, Vector3.zero, Handles.RectangleHandleCap);
                        }
                    }
                    ...
                    if ( haveSameTangents && tangentMode == TangentMode.Editable ) {
                        ...
                        if ( kIndex == k ) {
                            ...
                            if ( k != 0 ) {
                                ...
                                var fmh_223_84_639245411231150802 = Quaternion.identity; var newInHandle = Handles.FreeMoveHandle(inHandle, handleSize, Vector3.zero, Handles.CircleHandleCap);
                            ...
                            if ( k < curveX.length - 1 ) {
                                ...
                                var fmh_249_86_639245411231157783 = Quaternion.identity; var newOutHandle = Handles.FreeMoveHandle(outHandle, handleSize, Vector3.zero, Handles.CircleHandleCap);
